...
const App: React.FC = () => {
  ...
  const [prize, setPrize] = useState<string>(''); // New Prize State
  ...
  // Load items and prize from LocalStorage on mount
  useEffect(() => {
  ...
  // Save items and prize to LocalStorage whenever they change
  useEffect(() => {
